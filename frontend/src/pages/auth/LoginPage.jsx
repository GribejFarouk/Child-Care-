    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      >
        ...
        <h2 className="mt-6 text-center text-3xl font-bold text-primary-900 tracking-tight">
          {isLogin ? 'Connectez-vous à votre compte' : 'Créer un compte ChildCare+'}
        </h2>
        <p className="mt-2 text-center text-sm text-gray-500">
          {isLogin ? 'Accédez au dossier de votre enfant' : 'Rejoignez-nous pour un suivi simplifié'}
        </p>
      </motion.div>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white/70 text-gray-500">
                  {isLogin ? 'Nouveau sur ChildCare+ ?' : 'Déjà un compte ?'}
                </span>
              </div>
            </div>
