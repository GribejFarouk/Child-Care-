...
# --- Database ---
# Uses PostgreSQL when DB env vars are set, otherwise SQLite for local dev
if os.environ.get('AUTH_DB_NAME'):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ['AUTH_DB_NAME'],
            'USER': os.environ.get('AUTH_DB_USER', 'childcare'),
...
SIMPLE_JWT = {
    ...
    # Custom claims are added in views._get_tokens_with_claims()
}
