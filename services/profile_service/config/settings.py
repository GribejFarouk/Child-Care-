"""
Profile Service Django settings.
...
# --- Database ---
if os.environ.get('PROFILE_DB_NAME'):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ['PROFILE_DB_NAME'],
            'USER': os.environ.get('PROFILE_DB_USER', 'childcare'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'profiles.authentication.SharedJWTAuthentication',
    ),
