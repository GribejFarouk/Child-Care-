"""
Analytics Service Django settings.
...
# --- Database ---
if os.environ.get('NOTIFICATION_DB_NAME'):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ['NOTIFICATION_DB_NAME'],
            'USER': os.environ.get('NOTIFICATION_DB_USER', 'childcare'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'notifications.authentication.SharedJWTAuthentication',
    ),
