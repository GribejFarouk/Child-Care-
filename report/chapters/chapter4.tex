...
Ce chapitre présente la phase de réalisation du projet ChildCare+. Je décris l'environnement de développement, les technologies utilisées, l'organisation du code source, puis je présente les interfaces développées dans le cadre de la Phase~1 (MVP frontend). Enfin, je dresse un bilan de l'état d'avancement actuel du projet.
