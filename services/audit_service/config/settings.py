...
# --- Database ---
if os.environ.get('AUDIT_DB_NAME'):
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': os.environ['AUDIT_DB_NAME'],
            'USER': os.environ.get('AUDIT_DB_USER', 'childcare'),
            'PASSWORD': os.environ.get('AUDIT_DB_PASSWORD', ''),
            'HOST': os.environ.get('AUDIT_DB_HOST', 'localhost'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'audit.authentication.SharedJWTAuthentication',
    ),
